// ─────────────────────────────────────────────────────────────────────────────
// Mock learner state — used by HomeCrossroads while real data layer is wired up.
...
export const mockLearnerState = {
  ...
  primaryAction: {
    questLabel: 'CONTINUE QUEST: INTRO TO JAVA',
...
export const mockSubjects = [
  {
    ...
    currentTask: 'Learning Task 16 · For Loops',
    termProgress: 62,
    currentStep: 3,
    totalSteps: 7,
  },
